        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountCodeSeparator = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false, defaultValue: "."),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Property1 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Property2 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Property3 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Property4 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Property5 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccountPlans_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyBalances_AccountPlans_AccountPlanId",
                        column: x => x.AccountPlanId,
                        principalTable: "AccountPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MonthlyBalances_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Packages",
                columns: new[] { "Id", "Description", "IsActive", "MonthlyPrice", "Name" },
                values: new object[] { 1, "Tüm temel raporlara erişim", true, 299.00m, "Temel Paket" });

            migrationBuilder.CreateIndex(
                name: "IX_AccountPlans_CompanyId_AccountCode",
                table: "AccountPlans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_UserId_TaxNumber",
                table: "Companies",
                columns: new[] { "UserId", "TaxNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyBalances_AccountPlanId",
                table: "MonthlyBalances",
                column: "AccountPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyBalances_CompanyId_AccountPlanId_Year_Month",
                table: "MonthlyBalances",
                columns: new[] { "CompanyId", "AccountPlanId", "Year", "Month" },
                unique: true);
